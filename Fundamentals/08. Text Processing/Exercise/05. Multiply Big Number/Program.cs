...
namespace _2._Exer_5._Multiply_Big_Number
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // вместо while цикъла, може да махнем нулите още при четенето -------  string reallyBigNumber = Console.ReadLine().TrimStart('0');




            while (reallyBigNumber[0] == '0' || reallyBigNumber == "")
            {
