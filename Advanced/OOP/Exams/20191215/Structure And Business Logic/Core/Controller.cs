...
namespace AquaShop.Core.Contracts
{
    public class Controller : IController
    {
        ...
        public string CalculateValue(string aquariumName)
        {
            ...
            var totalPrice = aquarium.Fish.Sum(p => p.Price) + aquarium.Decorations.Sum(d => d.Price);
        ...
        public string InsertDecoration(string aquariumName, string decorationType)
        {
            ...
            string resultMessage = string.Format(OutputMessages.EntityAddedToAquarium, decorationType, aquariumName);
