...
namespace E7MilitaryElite.Core
{
    public class Engine : IEngine
    {
        ...
        public void Run()
        {
            ...
            while ((command = this.reader.ReadLine()) != "End")
            {
                ...
                else if (soldierType == "Commando")
                {
                    ...
                    try
                    {
                        ICommando commando = GetComando(cmdArgs, id, firstName, lastName, salary, corps);
        ...
        private static ICommando GetComando(string[] cmdArgs, int id, string firstName, string lastName, decimal salary, string corps)
        {
