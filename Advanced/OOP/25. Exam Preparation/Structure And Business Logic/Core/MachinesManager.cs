namespace MortalEngines.Core
{
    ...
    public class MachinesManager : IMachinesManager
    {
        ...
        public string AttackMachines(string attackingMachineName, string defendingMachineName)
        {
            ...
            {
                return $"Dead machine {attackingMachine} cannot attack or be attacked";
            }
            ...
            return $"Machine {defendingMachine} was attacked by machine {attackingMachine} - current health: {defendingMachine.HealthPoints:f2}";
        }
