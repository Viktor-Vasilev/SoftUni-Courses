import { editPlay, getPlayById } from '../api/data.js';
    ...
    <form @submit=${onSubmit} class="theater-form">
        ...
        <div>
            ...
            <textarea id="description" name="description"
                placeholder="Description">${play.description}</textarea>
        </div>
        <div>
...
export async function editPage(ctx) {
    const play = await getPlayById(ctx.params.id);
    ctx.render(editTemplate(play, onSubmit));
