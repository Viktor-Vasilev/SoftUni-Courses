...
namespace MusicHub.Data.Models
{
    public class Song
    {
        ...
        public int? AlbumId { get; set; } // правим го nullable - може да има песен, която не е в албум !!!
        public Album Album { get; set; } //navigational property

        public int WriterId { get; set; } // тук е Required, значи не може да е nullable 
        public Writer Writer { get; set; } //navigational property
